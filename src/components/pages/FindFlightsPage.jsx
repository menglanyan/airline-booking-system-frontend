            ...
            <form onSubmit={handleSearch} className="search-form">
                <div className="search-row">
                    ...
                    <div className="swap-cities">
                        <button type="button" onClick={handleSwapAirports} aria-label="Swap departure and arrival airports">
                            ↔
                        </button>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <select
                            ...
                            onChange={(e) => setSearchParams({...searchParams, arrivalIataCode: e.target.value})}>
